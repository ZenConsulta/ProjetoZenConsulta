...
public class OperadorViewController {
    ...
    @PostMapping
    public String salvar(@Valid @ModelAttribute("operador") OperadorDTO dto, BindingResult bindingResult, RedirectAttributes redirect) {
    ...
    public String atualizar(@PathVariable Long id, @Valid @ModelAttribute("operador") OperadorDTO dto, BindingResult bindingResult, RedirectAttributes redirect) {
        if (bindingResult.hasErrors()) {
            return "operadores/formulario";
        }
