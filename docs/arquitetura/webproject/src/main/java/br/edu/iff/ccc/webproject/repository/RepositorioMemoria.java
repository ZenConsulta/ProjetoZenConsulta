...
/**
 * Implementação genérica de Repositorio<T> guardando tudo em um Map em
 * memória (RNF: persistência mock, conforme roteiro da P1).
 *
 * Para não repetir a mesma lógica de "gerar id, salvar no Map, buscar,
 * remover" em cada entidade, essa classe é abstrata/genérica e recebe,
 * via construtor, como ler e como escrever o id de qualquer entidade T
 * (getId/setId), usando referências a método (Paciente::getId, etc).
 */
