...
/**
 * CRUD de SlotAgenda (RF01/RF14). Diferente das outras entidades, aqui não
 * existe "editar": um horário só é criado ou removido — editar um slot já
 * reservado quebraria a consistência do agendamento vinculado a ele.
 */
@Controller
...
public class SlotAgendaViewController {
    ...
    // Monta um Map<id, nome> só para facilitar a exibição na view (evita
    // fazer "busca por id" dentro do Thymeleaf, o que não é trivial).
