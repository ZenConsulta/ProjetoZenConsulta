...
/**
 * Controller de View para o CRUD de Paciente.
 * Padrão repetido nos outros controllers de entidade simples
 * (Profissional, Operador, Administrador): listar / novo / salvar / editar / excluir.
 */
@Controller
